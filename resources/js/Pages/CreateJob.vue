    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="number" class="form-control" id="salary_from" v-model="form.salary_from" />
        </div>
        <div class="col-md-6 mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="key_skills" v-model="form.key_skills" />
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="address" v-model="form.address" maxlength="255" />
      </div>
